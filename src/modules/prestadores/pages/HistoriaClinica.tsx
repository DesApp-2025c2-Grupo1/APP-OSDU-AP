    ...
    <main className="min-w-0 flex-1 overflow-y-auto bg-slate-50 pb-24 md:pb-0">
      ...
      <div className="space-y-4 p-4 sm:p-8">
        ...
        <section className="overflow-hidden rounded-2xl border border-slate-100 bg-white shadow-sm">
          <div className="flex flex-col gap-3 border-b border-slate-100 px-4 pt-5 sm:px-6 lg:flex-row lg:items-end lg:justify-between">
              ...
              {['Resumen', 'Notas clínicas', 'Antecedentes', 'Estudios', 'Recetas', 'Documentos'].map((tab, index) => (
                <button
                  ...
                  className={`-mb-px shrink-0 border-b-2 px-0 py-2.5 text-sm font-500 transition ${
                    index === 0 ? 'border-teal-500 text-teal-700' : 'border-transparent text-slate-500 hover:text-slate-700'
                  }`}
                >
                  {tab}
                </button>
            ...
            <div className="relative flex items-center gap-2 pb-3">
              ...
              <button
                ...
                className="flex h-10 min-w-44 items-center justify-between gap-3 rounded-xl border border-slate-200 px-3 text-left text-sm font-600 text-slate-600 transition hover:border-teal-200"
              >
                {filterLabel}
