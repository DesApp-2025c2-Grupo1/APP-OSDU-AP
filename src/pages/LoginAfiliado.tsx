  ...
  return (
    <div className="w-screen min-h-screen flex overflow-hidden">
      ...
      <div className="flex-1 flex items-center justify-center bg-white p-4 sm:p-8 relative">
        ...
        {/* Botón ingresar como prestador — esquina superior derecha */}
        <button
          onClick={() => navigate("/login/prestador")}
          className="absolute top-5 right-5 text-xs font-semibold text-unahur border border-green-200 hover:bg-green-50 px-4 py-2 rounded-xl transition-colors"
        >
